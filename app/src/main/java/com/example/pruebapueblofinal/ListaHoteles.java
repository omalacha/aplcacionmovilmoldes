...
public class ListaHoteles extends AppCompatActivity {
    ...
    public void crearLista(){
        ...
        listaHoteles.add(new MoldeHotel("Hotel el sancocho","350000",R.drawable.hotel1));
        listaHoteles.add(new MoldeHotel("Hotel 3","450000",R.drawable.hotel1));
        listaHoteles.add(new MoldeHotel("Hotel 4","550000",R.drawable.hotel1));
        listaHoteles.add(new MoldeHotel("Hotel 5","650000",R.drawable.hotel1));
